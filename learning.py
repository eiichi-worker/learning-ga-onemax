# 下のコードを理解する
# http://qiita.com/neka-nat@github/items/0cb8955bd85027d58c8e
# http://tech.mof-mof.co.jp/blog/ga-one-max-problem.html

# deap ドキュメント
# http://deap.gel.ulaval.ca/doc/dev/index.html
...
if __name__ == '__main__':
    ...
    CXPB, MUTPB, NGEN = 0.5, 0.1, 10  # 交差確率、突然変異確率、進化計算のループ回数
